...
%   diffusion, mechanical dispersion, microbial diffusion, or chemotaxis
%   are enabled at this 3D scale (1800 cells) -- those transport extras
%   are exercised separately on the 1D benchmark
